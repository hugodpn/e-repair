ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :admin do |admin|
    ...
    admin.resources :request_repairs
    admin.resources :equipment_types
    admin.resources :equipment_locations
    admin.resources :equipment_miscellaneous
    admin.resources :reason_faults
  ...
  map.root :controller => 'admin/request_repairs'
